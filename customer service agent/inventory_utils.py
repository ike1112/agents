...
# PURPOSE: Defines utilities for creating and managing pandas-based inventory and transaction dataframes.
#          Unlike 'inv_utils.py' which uses TinyDB, this module focuses on Pandas DataFrames.
#          It includes functions for checking stock, updating inventory, and plan execution loops with reflection.
# ==========================================
import copy
import json
import random
