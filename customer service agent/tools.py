# ==========================================
# FILE: tools.py
# PURPOSE: Provides a registry of "tools" (functions) for the agent to interact with the data.
#          It includes Read/Write operations for DuckDB/Pandas, helper calculations (total/refund),
#          and validation functions. It also handles argument resolution and tool execution logic.
# ==========================================
# =========================
# Imports
# =========================
