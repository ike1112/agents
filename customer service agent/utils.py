# ==========================================
# FILE: utils (1).py
# PURPOSE: General utility functions for formatting and display.
#          Primary function is `print_html` which renders dataframes, images, or text in styled HTML cards,
#          useful for notebook outputs or clear logging.
# ==========================================
# ================================
...
def print_html(content: Any, title: str | None = None, is_image: bool = False):
    ...
    - If running in Jupyter: Renders styled HTML cards.
    - If running in Terminal: Prints structured text/markdown.
    """
    # Detect if we are in a notebook environment
    try:
    ...
    if not is_notebook:
        ...
        if hasattr(content, "to_markdown"): # dataframes
