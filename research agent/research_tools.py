...
# Set a custom User-Agent to identify our script to the arXiv API.
# This is required by arXiv's Terms of Use to prevent anonymous scraping.
# Ideally, replace the email below with your own for contact in case of issues.
...
def tavily_search_tool(
    ...
    # So, if DLAI_TAVILY_BASE_URL is not in your .env file, os.getenv returns None, 
    # and the standard Tavily URL is used automatically.
